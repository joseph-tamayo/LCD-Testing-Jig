...
- Push Button *Note: in the jig featured above I'm using a toggle switch instead, this was done for a more consistent power draw and because using a push button caused some glitches in my jig, but it may have been caused by my wiring*
